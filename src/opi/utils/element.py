...
ATOMIC_MASSES_FROM_ELEMENT: dict[Element, float] = {
    ...
    Element.HE: 4.003,
    Element.HELIUM: 4.003,
    Element.LI: 6.941,
    Element.LITHIUM: 6.941,
    Element.BE: 9.012,
    Element.BERYLLIUM: 9.012,
    Element.B: 10.810,
    Element.BORON: 10.810,
    Element.C: 12.011,
    ...
    Element.TI: 47.900,
    Element.TITANIUM: 47.900,
    Element.V: 50.940,
    Element.VANADIUM: 50.940,
    Element.CR: 52.000,
    Element.CHROMIUM: 52.000,
    Element.MN: 54.940,
    Element.MANGANESE: 54.940,
    Element.FE: 55.850,
    Element.IRON: 55.850,
    Element.CO: 58.930,
    Element.COBALT: 58.930,
    Element.NI: 58.700,
    Element.NICKEL: 58.700,
    Element.CU: 63.550,
    ...
    Element.GE: 72.590,
    Element.GERMANIUM: 72.590,
    Element.AS: 74.920,
    Element.ARSENIC: 74.920,
    Element.SE: 78.960,
    Element.SELENIUM: 78.960,
    Element.BR: 79.900,
    Element.BROMINE: 79.900,
    Element.KR: 83.800,
    Element.KRYPTON: 83.800,
    Element.RB: 85.479,
    Element.RUBIDIUM: 85.479,
    Element.SR: 87.620,
    Element.STRONTIUM: 87.620,
    Element.Y: 88.910,
    ...
    Element.MO: 95.940,
    Element.MOLYBDENUM: 95.940,
    Element.TC: 97.000,
    Element.TECHNETIUM: 97.000,
    Element.RU: 101.070,
    Element.RUTHENIUM: 101.070,
    Element.RH: 102.910,
    Element.RHODIUM: 102.910,
    Element.PD: 106.400,
    Element.PALLADIUM: 106.400,
    Element.AG: 107.870,
    Element.SILVER: 107.870,
    Element.CD: 112.410,
    Element.CADMIUM: 112.410,
    Element.IN: 114.820,
    ...
    Element.TE: 127.600,
    Element.TELLURIUM: 127.600,
    Element.I: 126.900,
    Element.IODINE: 126.900,
    Element.XE: 131.300,
    Element.XENON: 131.300,
    Element.CS: 132.9054,
    Element.CESIUM: 132.9054,
    Element.BA: 137.3300,
    Element.BARIUM: 137.3300,
    Element.LA: 138.9055,
    Element.LANTHANUM: 138.9055,
    Element.CE: 140.1200,
    Element.CERIUM: 140.1200,
    Element.PR: 140.9077,
    ...
    Element.SM: 150.4000,
    Element.SAMARIUM: 150.4000,
    Element.EU: 151.9600,
    Element.EUROPIUM: 151.9600,
    Element.GD: 157.2500,
    Element.GADOLINIUM: 157.2500,
    Element.TB: 158.9254,
    Element.TERBIUM: 158.9254,
    Element.DY: 162.5000,
    Element.DYSPROSIUM: 162.5000,
    Element.HO: 164.9304,
    Element.HOLMIUM: 164.9304,
    Element.ER: 167.2600,
    Element.ERBIUM: 167.2600,
    Element.TM: 168.9342,
    ...
    Element.HF: 178.4900,
    Element.HAFNIUM: 178.4900,
    Element.TA: 180.9479,
    Element.TANTALUM: 180.9479,
    Element.W: 183.8500,
    Element.WOLFRAM: 183.8500,
    Element.RE: 186.2070,
    Element.RHENIUM: 186.2070,
    Element.OS: 190.2000,
    Element.OSMIUM: 190.2000,
    Element.IR: 192.2200,
    Element.IRIDIUM: 192.2200,
    Element.PT: 195.0900,
    Element.PLATINUM: 195.0900,
    Element.AU: 196.9665,
    ...
    Element.PB: 207.2000,
    Element.LEAD: 207.2000,
    Element.BI: 208.9804,
    Element.BISMUTH: 208.9804,
    Element.PO: 209.0000,
    Element.POLONIUM: 209.0000,
    Element.AT: 210.0000,
    Element.ASTATINE: 210.0000,
    Element.RN: 222.0000,
    Element.RADON: 222.0000,
    Element.FR: 223.0000,
    Element.FRANCIUM: 223.0000,
    Element.RA: 226.0254,
    Element.RADIUM: 226.0254,
    Element.AC: 227.0278,
    ...
    Element.U: 238.0290,
    Element.URANIUM: 238.0290,
    Element.NP: 237.0482,
    Element.NEPTUNIUM: 237.0482,
    Element.PU: 244.0000,
    Element.PLUTONIUM: 244.0000,
    Element.AM: 243.0000,
    Element.AMERICIUM: 243.0000,
    Element.CM: 247.0000,
    Element.CURIUM: 247.0000,
    Element.BK: 247.0000,
    Element.BERKELIUM: 247.0000,
    Element.CF: 251.0000,
    Element.CALIFORNIUM: 251.0000,
    Element.ES: 252.0000,
    ...
    Element.NO: 259.0000,
    Element.NOBELIUM: 259.0000,
    Element.LR: 262.0000,
    Element.LAWRENCIUM: 262.0000,
    Element.RF: 267.0000,
    Element.RUTHERFORDIUM: 267.0000,
    Element.DB: 268.0000,
    Element.DUBNIUM: 268.0000,
    Element.SG: 269.0000,
    Element.SEABORGIUM: 269.0000,
    Element.BH: 270.0000,
    Element.BOHRIUM: 270.0000,
    Element.HS: 269.0000,
    Element.HASSIUM: 269.0000,
    Element.MT: 278.0000,
    ...
    Element.CN: 285.0000,
    Element.COPERNICIUM: 285.0000,
    Element.NH: 283.0000,
    Element.NIHONIUM: 283.0000,
    Element.FL: 289.0000,
    Element.FLEROVIUM: 289.0000,
    Element.MC: 288.0000,
    Element.MOSCOVIUM: 288.0000,
    Element.LV: 293.0000,
    Element.LIVERMORIUM: 293.0000,
    Element.TS: 294.0000,
    Element.TENNESSINE: 294.0000,
    Element.OG: 294.0000,
    Element.OGANESSON: 294.0000,
}
