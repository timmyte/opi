...
The project follows the [Keep a Changelog](https://keepachangelog.com/en/1.1.0/) convention for release notes;
entries should start with an upper-case letter and end with the pull request reference (e.g. `(#42)`).
